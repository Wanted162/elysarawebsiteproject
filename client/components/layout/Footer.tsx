...
export function Footer() {
  return <footer className="bg-secondary text-secondary-foreground">
    <div className="mx-auto grid max-w-7xl gap-12 px-6 py-16 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1.25fr] lg:px-10">
      <div><Link to="/" className="flex items-center gap-2"><img src="https://cdn.builder.io/api/v1/image/assets%2F4215d9916ba54932a9c5dfbeef662b8a%2F6bd145047a444341bc8bc140642abd85?format=webp&width=800&height=1200" alt="Elysara Organics and Lifestyle" className="h-16 w-12 object-contain" /></Link><p className="mt-6 max-w-xs text-sm leading-7 text-secondary-foreground/65">Botanical blends and nourishing rituals, thoughtfully made for your everyday well-being.</p><div className="mt-6 flex gap-3"><span className="rounded-full border border-secondary-foreground/20 p-2"><Sparkles size={15} /></span></div></div>

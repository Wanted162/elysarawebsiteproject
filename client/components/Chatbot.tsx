...
export function Chatbot() {
  ...
  return <div className="fixed bottom-5 right-5 z-[60] sm:bottom-7 sm:right-7">
    {open && <div role="dialog" aria-label="Elysara assistant" className="mb-3 flex h-[min(660px,calc(100vh-112px))] w-[min(390px,calc(100vw-2rem))] flex-col overflow-hidden rounded-[1.5rem] border border-border bg-background shadow-2xl">
